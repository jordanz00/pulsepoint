import { PULSE_ENGAGE_SPOTLIGHT } from "@/lib/marketing-content";
import { CapabilityList } from "@/components/marketing/capability-list";

export function EngageSpotlightSection() {
  const s = PULSE_ENGAGE_SPOTLIGHT;

  return (
    <section id="pulsepoint-engage" className="border-t border-slate-200 bg-white py-16">
