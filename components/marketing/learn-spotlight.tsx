import { PULSE_LEARN_SPOTLIGHT } from "@/lib/marketing-content";
import { CapabilityList } from "@/components/marketing/capability-list";

export function LearnSpotlightSection() {
  const s = PULSE_LEARN_SPOTLIGHT;

  return (
    <section id="pulsepoint-learn" className="border-t border-slate-200 bg-slate-50 py-16">
