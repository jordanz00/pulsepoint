...
export function WorkSpotlightSection() {
  const s = PULSE_WORK_SPOTLIGHT;

  return (
    <section id="pulsepoint-work" className="border-t border-slate-200 bg-white py-16">
      <div className="mx-auto max-w-3xl">
        ...
        <CapabilityList
          title={s.ecosystemTitle}
          items={s.ecosystemItems}
          className="mt-8"
        />
