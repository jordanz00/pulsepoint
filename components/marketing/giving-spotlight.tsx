import { PULSE_GIVING_SPOTLIGHT } from "@/lib/marketing-content";
import { CapabilityList } from "@/components/marketing/capability-list";

export function GivingSpotlightSection() {
  const s = PULSE_GIVING_SPOTLIGHT;

  return (
    <section id="pulsepoint-giving" className="border-t border-slate-200 bg-white py-16">
