import { PULSE_INSIGHTS_SPOTLIGHT } from "@/lib/marketing-content";
import { CapabilityList } from "@/components/marketing/capability-list";

export function InsightsSpotlightSection() {
  const s = PULSE_INSIGHTS_SPOTLIGHT;

  return (
    <section id="pulsepoint-insights" className="border-t border-slate-200 bg-slate-50 py-16">
