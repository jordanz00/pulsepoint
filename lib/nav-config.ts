...
export function buildAdminNav(orgSlug: string): AdminNavItem[] {
  ...
  const items: AdminNavItem[] = [
    ...
    },
    {
      ...
      status: "live",
      group: "command",
      description: "15-min CEO briefing script with live stats",
    },
    {
      id: "mission-control",
      ...
      status: "live",
      group: "command",
      description: "Quake OS ship workflow and build telemetry",
    },
    {
      id: "flagship",
      ...
      status: "live",
      group: "command",
      description: "Five buyer-facing capabilities with live tenant stats",
    },
    {
      id: "showcase",
      name: "Top 20 showcase",
      href: `${base}/showcase`,
      iconId: "suite",
      status: "live",
      group: "command",
      description: "20 highly visible features with live tenant stats",
    },
    {
      id: "suite",
      name: "All modules",
